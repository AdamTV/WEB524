    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Models.Country, Models.CountryBaseViewModel>();

                cfg.CreateMap<Models.Manufacturer, Models.ManufacturerBaseViewModel>();
                cfg.CreateMap<Models.Manufacturer, Models.ManufacturerWithDetailViewModel>();

                cfg.CreateMap<Models.Vehicle, Models.VehicleBaseViewModel>();
                cfg.CreateMap<Models.Vehicle, Models.VehicleWithDetailViewModel>();
                cfg.CreateMap<Models.VehicleAddViewModel, Models.Vehicle>();
