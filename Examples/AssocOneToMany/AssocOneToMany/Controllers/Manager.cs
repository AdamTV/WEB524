...
using System.IO;
using Excel;
using AssocOneToMany.EntityModels;
...
namespace AssocOneToMany.Controllers
{
    public class Manager
    {
        ...
        public TeamBaseViewModel TeamGetById(int id)
        {
            ...
            return (o == null) ? null : mapper.Map<Team, TeamBaseViewModel> (o);
        }
        ...
        public TeamWithPlayersViewModel TeamGetByIdWithPlayers(int id)
        {
            ...
            // Return the result, or null if not found
            return (o == null) ? null : mapper.Map<Team, TeamWithPlayersViewModel>(o);
        }
        ...
        public IEnumerable<PlayerWithTeamNameViewModel> PlayerGetAllWithTeamName()
        {
            ...
            return mapper.Map<IEnumerable<Player>, IEnumerable<PlayerWithTeamNameViewModel>>(c);
        }
